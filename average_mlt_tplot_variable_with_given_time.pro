PRO average_mlt_data_y, data, tag, average_time,time_avg, y_avg=y_avg, yfound=yfound,sum_up=sum_up
...
; calculate mean of the data for time points
  FOR itime = 0l, n_avg-1 DO BEGIN
     ...
     IF ct GT 0 AND TOTAL(ABS(data_y[index, *]) GE 0,/NAN) GT 0 and ct ge 2 THEN BEGIN
